...
# --- Configuration (all dynamically loaded from environment) ---
...
def load_config():
    """Load the config file dynamically. The app is NOT ready until this succeeds."""
...
<div class="meta">
  ...
  Served by pod111111: <code>{{ hostname }}</code>
</div>
"""
